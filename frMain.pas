...
uses
  ...
  FireDAC.Comp.Client, FMX.Edit, FMX.SearchBox, System.Math.Vectors,
...
procedure TFMain.LoginClick(Sender: TObject);
begin
if (userName.Text = 'admin') and (Pswd.Text = 'admin') then
begin
    tcMain.ActiveTab := tiData;
    // load data
  end
